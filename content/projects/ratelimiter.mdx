---
title: "Rate Limiter"
description: I have recently started learning SystemDesign, I found rate-limiters are fascinating so I created different 
algos for different methods.
repository: Hemanth-Thaluru/RateLimiter
date: "2023-05-21"
published: true
...
- RateLimiter
- Limits the excessive calls.



```ts
import { Tinybird } from "@Hemanth_thaluru/RateLimter";
import { z } from "zod";
...
const res = await getEvents({ tenantId: "hemanth" })
